...
Route::group(array('prefix' => 'super-admin', 'middleware' => 'super_admin'), function () {
    ...
    Route::group(array('prefix' => 'professional-modules'), function () {
        Route::get('/', [App\Http\Controllers\SuperAdmin\ProfessionalModulesController::class, 'index']);
        Route::post('/ajax-list', [App\Http\Controllers\SuperAdmin\ProfessionalModulesController::class, 'getAjaxList']); 
        Route::get('/add', [App\Http\Controllers\SuperAdmin\ProfessionalModulesController::class, 'add']);
        Route::post('/save', [App\Http\Controllers\SuperAdmin\ProfessionalModulesController::class, 'save']); 
        Route::get('/delete/{id}', [App\Http\Controllers\SuperAdmin\ProfessionalModulesController::class, 'deleteSingle']); 
        Route::post('/delete-multiple', [App\Http\Controllers\SuperAdmin\ProfessionalModulesController::class, 'deleteMultiple']); 
        Route::get('/edit/{id}', [App\Http\Controllers\SuperAdmin\ProfessionalModulesController::class, 'edit']); 
        Route::post('/update/{id}', [App\Http\Controllers\SuperAdmin\ProfessionalModulesController::class, 'update']);
        Route::post('/search/{key}', [App\Http\Controllers\SuperAdmin\ProfessionalModulesController::class, 'search']); 
...
Route::group(array('prefix' => 'manager'), function () {
    Route::group(array('middleware' => 'manager'), function () {
      ...
      Route::group(array('prefix' => 'cases'), function () {
            ...
            Route::get('/view-document/{case_id}/{doc_id}', [App\Http\Controllers\Manager\CasesController::class, 'viewDocument']);
        });
});
