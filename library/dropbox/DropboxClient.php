...
class DropboxClient {
	 ...
	 * @throws DropboxException
	 */
    public function GetFiles( $path = '', $recursive = false, $include_deleted = false , $include_media_info = true,$key_num = false  ) {
        ...
        $res     = $this->apiCall( "2/files/list_folder", compact( 'path', 'recursive', 'include_deleted','include_media_info' ) );
        $entries = $res->entries;
