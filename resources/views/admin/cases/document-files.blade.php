         ...
         <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb breadcrumb-no-gutter">
                  ...
                  <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Folder Name</a></li>
            ...
            <div class="btn-group" role="group">
               ...
               <div class="hs-unfold btn-group">
                  ...
                  <div id="uploadGroupDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right">
                     ...
                     <i class="tio-folder-add dropdown-item-icon"></i> New folder
                     </a>
                     <a class="dropdown-item" href="#">
                     <i class="tio-folder-shared dropdown-item-icon"></i> New shared folder
                     </a>
                     ...
                     <a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#uploadFilesModal">
                     <i class="tio-publish dropdown-item-icon"></i> Upload folder
                     </a>
                  </div>
               </div>
               <!-- End Unfold -->
