                ...
                <div class="input-group-add-field">
                  <div class="row">
                    <div class="col-md-6 js-form-message">
                      <input type="text" class="form-control mb-3 particular_name" placeholder="Item name" aria-label="Item name" value="{{$item->particular_name}}">
                    </div>
                    <div class="col-md-6 js-form-message">
                      <input type="number" class="form-control-plaintext mb-3 amount" placeholder="{{currencyFormat()}}0.00" value="{{$item->amount}}" aria-label="{{currencyFormat()}}0.00">
                    </div>
                  </div>
