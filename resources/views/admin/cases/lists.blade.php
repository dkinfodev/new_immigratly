...
<div class="content container-fluid">
  ...
  <div id="chat-circle" class="btn btn-raised">
        ...
        <i class="tio-sms-chat" style="font-size:22px;"></i>
  </div>
  
  <div class="chat-box">
    <div class="chat-box-header">
      ChatBot
      <span class="chat-box-toggle"><i class="tio-clear"></i></span>
    </div>
    <div class="chat-box-body">
      <div class="chat-box-overlay">   
      </div>
      <div class="chat-logs" style="word-break: break-all;">
    ...
    <div class="chat-input">      
      ...
      <button type="submit" class="chat-submit" id="chat-submit"><i class="tio-send"></i></button>
      </form>      
    </div>
  </div>
   End chat box -->
...
$(function() {
  ...
  function generate_message(msg, type) {
    ...
    str += "<img src=\"https:\/\/www.kindpng.com\/picc\/m\/78-786207_user-avatar-png-user-avatar-icon-png-transparent.png\">";
    str += "          <\/span>";
