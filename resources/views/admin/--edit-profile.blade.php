  ...
  <div class="row">
    <div class="col-lg-3">
      ...
      <div class="navbar-vertical navbar-expand-lg mb-3 mb-lg-5">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{baseUrl('edit-profile#emailSection')}}">
            <i class="tio-online nav-icon"></i>
            Email
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{baseUrl('edit-profile#passwordSection')}}">
...
<div class="card mb-3 mb-lg-5">
  ...
  <div class="card-body">
    ...
    <form>  
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-9">
          <div class="input-group input-group-sm-down-break">
            <input type="text" class="form-control" name="first_name" id="first_name" placeholder="Your first name" aria-label="Your first name" >
            <input type="text" class="form-control" name="last_name" id="last_name" placeholder="Your last name" aria-label="Your last name">
          </div>
        </div>
      </div>
      <!-- End Form Group -->
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-9">
          <input type="email" class="form-control" name="email" id="email" placeholder="Your email" aria-label="Email" value="mark@example.com">
        </div>
      </div>
      <!-- End Form Group -->
        ...
        <div class="col-sm-2">
          <select name="country_code" class="form-control">
            ...
            @foreach($countries as $key=>$c)
              <option id="{{$c->phonecode}}">{{$c->phonecode}}</option>
            @endforeach
      ...
      <!-- Form Group -->
      <div class="row form-group">
        <label for="dateofbirth" class="col-sm-3 col-form-label input-label">Date of birth</label>

        <div class="col-sm-9">
          <input type="date" class="form-control" name="dob" id="dob" placeholder="Enter date" aria-label="Enter your birth date">
        </div>
      </div>
      <!-- End Form Group -->
      ...
      <div class="mb-3">
        <input type="text" class="form-control" name="state" id="stateLabel" placeholder="State" aria-label="State" value="">
      </div>
  ...
  <div class="row form-group">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" name="address" id="address" placeholder="Your address" aria-label="Your address" value="45 Roker Terrace, Latheronwheel">
    </div>
  </div>
  <!-- End Form Group -->
  ...
  <!-- Form Group -->
  <div class="row form-group">
    <label class="col-sm-3 col-form-label input-label">Zip code <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="You can find your code in a postal address."></i></label>

    <div class="col-sm-9">
      <input type="text" class="js-masked-input form-control" name="zipcode" id="zipcode" placeholder="Your zip code" aria-label="Your zip code" value="KW5 8NW"
  ...
  <div class="card-body">
    ...
    <form id="changePasswordForm">
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-9">
          <input type="password" class="form-control" name="password" id="password" placeholder="Enter current password" aria-label="Enter current password">
        </div>
      </div>
      <!-- End Form Group -->
