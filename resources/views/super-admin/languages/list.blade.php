        ...
        <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
          <form>
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch" onchange="search(this.value)" type="search" class="form-control" placeholder="Search Language" aria-label="Search Language">
            </div>
            <!-- End Search -->
          </form>
        </div>
...
function loadData(page=1){
    $.ajax({
        type: "POST",
        url: BASEURL + '/languages/list?page='+page,
        data:{
            _token:csrf_token
        },
        dataType:'json',
...
function search(keyword){
    $.ajax({
        type: "POST",
        url: BASEURL + '/languages/search/'+keyword,
        data:{
            _token:csrf_token
        },
        dataType:'json',
