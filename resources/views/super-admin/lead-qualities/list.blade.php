  ...
  <div class="page-header">
    <div class="row align-items-end">
      <div class="col-sm mb-2 mb-sm-0">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-no-gutter">
            ...
            <li class="breadcrumb-item active" aria-current="page">Lead Qualities</li>
          </ol>
        </nav>
      ...
      <div class="col-sm-auto">
        <a class="btn btn-primary" href="{{ baseUrl('/lead-qualities/add') }}">
        ...
        <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
          <form>
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch" onchange="search(this.value)" type="search" class="form-control" placeholder="Search Lead Quality" aria-label="Search Quality">
            </div>
            <!-- End Search -->
          </form>
        </div>
...
function loadData(page=1){
    $.ajax({
        type: "POST",
        url: BASEURL + '/lead-qualities/list?page='+page,
        data:{
            _token:csrf_token
        },
        dataType:'json',
...
function search(keyword){
    $.ajax({
        type: "POST",
        url: BASEURL + '/lead-qualities/search/'+keyword,
        data:{
            _token:csrf_token
        },
        dataType:'json',
