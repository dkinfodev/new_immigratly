...
<div class="content container-fluid">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form id="leadQualities-form" class="js-validate" action="{{ baseUrl('/lead-qualities/save') }}" method="post">
        ...
        <div class="js-form-message form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" name="name" id="name" placeholder="Enter Lead Quality" class="form-control">
          </div>
        </div>
        <!-- End Input Group -->
        ...
        <div class="js-form-message form-group row">
          ...
          <div class="col-sm-10">
            <input type="number" name="point" id="point" placeholder="Enter points" min="1" max="5" class="form-control">
          </div>
        </div>
        <!-- End Input Group -->
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $(".add-btn").click(function(e){
        ...
        $.ajax({
          url:"{{ baseUrl('lead-qualities/save') }}",
          type:"post",
          data:formData,
          dataType:"json",
          beforeSend:function(){
