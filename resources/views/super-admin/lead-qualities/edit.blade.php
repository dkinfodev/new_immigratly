...
<div class="content container-fluid">
  ...
  <div class="page-header">
    <div class="row align-items-end">
      <div class="col-sm mb-2 mb-sm-0">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-no-gutter">
            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ baseUrl('/lead-qualities') }}">Lead Qualities</a></li>
      ...
      <div class="col-sm-auto">
        <a class="btn btn-primary" href="{{baseUrl('lead-qualities/')}}">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form id="leadQualities-form" class="js-validate" action="{{ baseUrl('/lead-qualities/update') }}" method="post">
        ...
        <div class="js-form-message form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" name="name" id="name" placeholder="Enter lead quality" class="form-control" value="{{$record->name}}">
          </div>
        ...
        <div class="js-form-message form-group row">
          ...
          <div class="col-sm-10">
            <input type="number" name="point" id="point" placeholder="Enter point" class="form-control" value="{{$record->point}}">
          </div>
        </div>
        <!-- End Input Group -->
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $(".update-btn").click(function(e){
        ...
        var id = $("#rid").val();
        var name = $("#name").val();
        var formData = $("#leadQualities-form").serialize();
        $.ajax({
          url:"{{ baseUrl('lead-qualities/update') }}",
          type:"post",
          data:formData,
          dataType:"json",
          beforeSend:function(){
