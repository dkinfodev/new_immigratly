...
<div class="content container-fluid">
      ...
      <div class="col-sm mb-2 mb-sm-0">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-no-gutter">
            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ baseUrl('/program-types') }}">Program Types</a></li>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form id="programTypes-form" class="js-validate" action="{{ baseUrl('/program-types/update/'.base64_encode($record->id)) }}" method="post">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $(".update-btn").click(function(e){
        ...
        var id = $("#rid").val();
        var name = $("#name").val();
        var formData = $("#programTypes-form").serialize();
        var url = $("#programTypes-form").attr('action');
        $.ajax({
          url:url,
          type:"post",
          data:formData,
