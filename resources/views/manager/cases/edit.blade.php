                        ...
                        >
                          ...
                          @foreach($visa_services as $service)
                            @if(!empty($service->Service($service->service_id)))
                              <option {{ ($record->visa_service_id == $service->unique_id)?'selected':'' }} value="{{$service->id}}">{{$service->Service($service->service_id)->name}} </option>
                            @endif
                          @endforeach
                        </select>
                      </div>
                      ...
                      <div class="js-form-message form-group">
                        ...
                        >
                          ...
                          @foreach($staffs as $staff)
                            <option {{ in_array($staff->id,$ids)?'selected':'' }} data-name="{{$staff->first_name.' '.$staff->last_name}}" data-role="{{ $staff->role }}" value="{{$staff->id}}">{{$staff->first_name.' '.$staff->last_name}} ({{$staff->role}})</option>
                          @endforeach
                        </select>
                      </div>
                     <!-- End Form Group -->
