          ...
          <div class="navbar-expand-lg navbar-expand-lg-collapse-block">
            ...
            <div id="sidebarNav" class="collapse navbar-collapse">
              <div class="mt-5 mt-lg-0">
                ...
                <h2 class="h4"><a class="text-inherit" href="#">Filter By Category</a></h2>

          
                @foreach($services as $service)
                <a class="dropdown-item d-flex justify-content-between align-items-center px-0" href="{{$service->id}}">
                  {{$service->name}}
                </a>
                @endforeach
