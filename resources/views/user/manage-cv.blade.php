                  ...
                  <div id="navbarVerticalNavMenu" class="collapse navbar-collapse">
                     ...
                     <ul id="navbarSettings" class="js-sticky-block js-scrollspy navbar-nav navbar-nav-lg nav-tabs card card-navbar-nav"
                        ...
                        <li class="nav-item">
                           ...
                           Personal information <span class="text-success"><i class="tio-checkmark-circle"></i></span>
                           </a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="/#workExpirences">
                           <i class="tio-online nav-icon"></i>
                           Work Expirences 
                           
                           @if(count($work_expirences) <= 0)
                              <span class="text-danger"><i class="tio-warning"></i></span>
                           @else
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="/#educationQualifications">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="/#languageProficiency">
