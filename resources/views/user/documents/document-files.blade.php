          ...
          <!-- Dropzone -->
            <div id="attachFilesLabel" class="js-dropzone dropzone-custom custom-file-boxed"
               data-hs-dropzone-options='{
                  "url": "<?php echo baseUrl('documents/upload-documents') ?>?_token=<?php echo csrf_token() ?>",
                  "thumbnailWidth": 100,
                  "thumbnailHeight": 100
               }'
            >
            ...
            <div class="col-12 col-md">
               <form>
                  <div class="input-group input-group-merge input-group-borderless">
                     ...
                     <input id="datatableSearch" type="search" class="form-control" placeholder="Search users" aria-label="Search file">
                  </div>
               </form>
            </div>
            <div class="col-auto">
                  ...
                  <td class="table-column-pl-0">
                     <a class="d-flex align-items-center" href="javascript:;">
                        <?php 
                           ...
                           $filesize = file_size(userDir()."/documents/".$doc->file_name);
                        ?>
                        <div class="ml-3">
