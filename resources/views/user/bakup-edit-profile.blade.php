    ...
    <div class="card-body">
      ...
      <div class="row justify-content-md-between">
        <div class="col-md-6">
          ...
          <!-- Form Group -->
          <div class="row form-group">
            <label class="col-sm-12 col-form-label input-label">Gender</label>
          ...
          <!-- Form Group -->
          <div class="row form-group">
            <label class="col-sm-12 col-form-label input-label">Date of Birth</label>
            <div class="col-sm-12">
          ...
          <!-- Form Group -->
          <div class="row form-group">
            <label class="col-sm-12 col-form-label input-label">Languages Known</label>
        ...
        <div class="col-md-6">
           ...
           <!-- Form Group -->
          <div class="row form-group">
            <label class="col-sm-12 col-form-label input-label">Country</label>
            <div class="col-sm-12">
              <div class="js-form-message">
          ...
          <!-- Form Group -->
          <div class="row form-group">
            <label class="col-sm-12 col-form-label input-label">State</label>
            <div class="col-sm-12">
              <div class="js-form-message">
          ...
          <!-- Form Group -->
          <div class="row form-group">
            <label class="col-sm-12 col-form-label input-label">City</label>
            <div class="col-sm-12">
              <div class="js-form-message">
          ...
          <!-- Form Group -->
          <div class="row form-group">
            <label class="col-sm-12 col-form-label input-label">Address</label>
            <div class="col-sm-12">
              <div class="js-form-message">
          ...
          <!-- Form Group -->
          <div class="row form-group">
            <label class="col-sm-12 col-form-label input-label">Zip Code</label>
            <div class="col-sm-12">
              <div class="js-form-message">
